...
def upload_gpt_large_model(device):
...
def upload_gpt_small_model(device):
    model_path = 'ai-forever/rugpt3small_based_on_gpt2'
...
def predict_class(text, tokenizer, model, classes, device):
